...
public class EducationLeave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_education_leave);
            ...
            public void onClick(View v) {
                ...
                if(toaddress.length() ==0 ||  body.length()==0){
                    ...
                    if(isneeded()) {
                        ...
                        email.putExtra(Intent.EXTRA_SUBJECT, " Application for educational leave");
    ...
    private boolean isneeded() {
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                int  cno = value.getLong("edu_levave").intValue();
                if(cno >= 30){
                    AlertDialog difg = new AlertDialog.Builder(EducationLeave.this)
                            .setTitle("Sorry")
                            .setMessage("You have  ALerdy used all your leaves")
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    startActivity(new Intent(EducationLeave.this , Dashboard.class));
                                    dialog.dismiss();
                                }
                            })
                            .create();
    ...
    private void updateLeaveNo() {
        ...
        DocumentReference documentReference = fstore.collection("Users").document(fAuth.getCurrentUser().getUid());
        documentReference.update("edu_levave", FieldValue.increment(1)).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(EducationLeave.this, "SUccesfuly updated", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EducationLeave.this, "Failed to updte", Toast.LENGTH_SHORT).show();
            }
        });
